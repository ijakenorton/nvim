...
setlocal spelloptions=
setlocal statuscolumn=
setlocal statusline=%#lualine_a_command#\ COMMAND\ %#lualine_transitional_lualine_a_command_to_lualine_c_command#%<%#lualine_c_command#\ .zshrc\ %#lualine_c_command#%=%#lualine_c_command#\ utf-8\ %#lualine_c_command#\ \ %#lualine_c_command#\ zsh\ %#lualine_transitional_lualine_b_command_to_lualine_c_command#%#lualine_b_command#\ 86%%\ %#lualine_transitional_lualine_a_command_to_lualine_b_command#%#lualine_a_command#\ 107:44\ 
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'zsh'
